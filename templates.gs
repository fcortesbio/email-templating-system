    ...
    "Login Problems": {
      "Forgot Password": {
        resolution: {
          ...
          backend_note:
            "Check if user has active lockout in backend. If locked, must be manually unlocked before reset.",
      ...
      "Account Locked": {
        resolution: {
          ...
          backend_note:
            "Use admin tool > security > lockouts to check reason code. Only reset if reason code is 1-3.",
    ...
    "Billing Issues": {
      "Update Payment Method": {
        resolution: {
          ...
          backend_note:
            "Do not access or view full payment details. Only confirm last 4 digits for verification.",
      ...
      "Disputed Charge": {
        resolution: {
          ...
          backend_note:
            "Check transaction log in Billing > Transactions > Search by ID. Look for error codes or notes.",
    ...
    "Installation Issues": {
      "Error Messages": {
        resolution: {
          ...
          backend_note:
            "Common errors: ERR-102 (permission), ERR-305 (network), ERR-418 (compatibility). Check KB for solutions.",
      ...
      "Compatibility Issues": {
        resolution: {
          ...
          backend_note:
            "Minimum requirements: Windows 10/macOS 10.14, 4GB RAM, 2GHz processor. Check for known issues with specific hardware.",
    ...
    "Performance Issues": {
      "Slow Operation": {
        resolution: {
          ...
          backend_note:
            "Check recent performance tickets. Known issues with v2.3 on older systems. Suggest cache clearing first.",
  ...
  "Feature Requests": {
    "New Feature": {
      resolution: {
        ...
        backend_note:
          "Submit all feature requests via the Feature Request Tool. Search first to avoid duplicates.",
    ...
    "Feature Enhancement": {
      resolution: {
        ...
        backend_note:
          "Use Enhancement Request form in agent portal. Include current behavior and desired behavior clearly.",
